object FRelNF: TFRelNF
  ...
  object QuickRep1: TQuickRep
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Relat'#243'rio de NF'#39's de Venda'
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
  ...
  object QryGenerica: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select CD.nome, V.DataVenda, v.TipoNota, v.NroNF /* BOLAR ALGO P' +
        'ARA COLOCAR O TOTAL DA NOTA */  from Vendas V'
    ...
    object QryGenericaNRONF: TIntegerField
      FieldName = 'NRONF'
      Origin = '"VENDAS"."NRONF"'
    end
  end
