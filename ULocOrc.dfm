object FLocOrc: TFLocOrc
  Left = 192
  Top = 109
  AutoSize = True
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Localiza'#231#227'o de Or'#231'amentos'
  ClientHeight = 393
  ClientWidth = 608
  Color = clBtnFace
  ...
  object DSBuscaOrc: TDataSource
    DataSet = QryBuscaOrc
    Left = 112
    Top = 208
  end
  object QryBuscaOrc: TIBQuery
    Database = Dados.Database
    Transaction = FOrcamento.TransactionOrc
    SQL.Strings = (
      
        'select o.CodOrcamento, c.nome, o.dataorcamento, o.contato, o.con' +
        'dpgto, o.prazoentrega from orcamentos O'
      'inner join clientes c on c.codcliente = o.codcliente')
    Left = 120
    Top = 176
    object QryBuscaOrcNOME: TIBStringField
      FieldName = 'NOME'
      Origin = '"CLIENTES"."NOME"'
      Size = 75
    end
    object QryBuscaOrcDATAORCAMENTO: TDateField
      FieldName = 'DATAORCAMENTO'
      Origin = '"ORCAMENTOS"."DATAORCAMENTO"'
    end
    object QryBuscaOrcCONTATO: TIBStringField
      FieldName = 'CONTATO'
      Origin = '"ORCAMENTOS"."CONTATO"'
      Size = 50
    end
    object QryBuscaOrcCONDPGTO: TIBStringField
      FieldName = 'CONDPGTO'
      Origin = '"ORCAMENTOS"."CONDPGTO"'
      Size = 25
    end
    object QryBuscaOrcPRAZOENTREGA: TIBStringField
      FieldName = 'PRAZOENTREGA'
      Origin = '"ORCAMENTOS"."PRAZOENTREGA"'
      Size = 25
    end
    object QryBuscaOrcCODORCAMENTO: TIntegerField
  ...
  object QryPrazoEntr: TIBQuery
    Database = Dados.Database
    Transaction = FOrcamento.TransactionOrc
    SQL.Strings = (
      
        'select distinct(O.prazoentrega) from ORCAMENTOS O where O.prazoe' +
        'ntrega is not null'
      'order by O.prazoentrega')
    Left = 312
    Top = 72
    object QryPrazoEntrPRAZOENTREGA: TIBStringField
      FieldName = 'PRAZOENTREGA'
      Origin = '"ORCAMENTOS"."PRAZOENTREGA"'
      Size = 25
    end
  ...
  object QryCondPgto: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select distinct(O.condpgto) from ORCAMENTOS O where O.condpgto i' +
        's not null'
      'order by O.condpgto')
    Left = 272
    Top = 48
    object QryCondPgtoCONDPGTO: TIBStringField
      FieldName = 'CONDPGTO'
      Origin = '"ORCAMENTOS"."CONDPGTO"'
      Size = 25
    end
  ...
  object QryContato: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select distinct(O.contato) from ORCAMENTOS O where O.Contato is ' +
        'not null'
      'order by O.Contato')
    Left = 240
    Top = 24
    object QryContatoCONTATO: TIBStringField
      FieldName = 'CONTATO'
      Origin = '"ORCAMENTOS"."CONTATO"'
      Size = 50
    end
