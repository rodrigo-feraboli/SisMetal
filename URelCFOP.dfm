object FRelCFOP: TFRelCFOP
  Left = 191
  Top = 153
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Emiss'#227'o de Relat'#243'rios de CFOP '
  ClientHeight = 67
  ClientWidth = 335
  Color = clBtnFace
  ...
  object QryCFOP: TIBQuery
    ...
    Left = 296
    Top = 16
    object QryCFOPCODCFOP: TIntegerField
      FieldName = 'CODCFOP'
      Origin = 'CFOP.CODCFOP'
      Required = True
    end
    object QryCFOPNOME: TIBStringField
      FieldName = 'NOME'
      Origin = 'CFOP.NOME'
      Size = 100
    end
    object QryCFOPCFOP: TIBStringField
      FieldName = 'CFOP'
      Origin = 'CFOP.CFOP'
      EditMask = '9.999;0;_'
      Size = 10
