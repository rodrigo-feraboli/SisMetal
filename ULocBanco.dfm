object FLocBanco: TFLocBanco
  Left = 201
  Top = 117
  AutoSize = True
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Busca Avan'#231'ada de Bancos'
  ClientHeight = 391
  ClientWidth = 617
  Color = clBtnFace
  ...
  object QryBuscaBanco: TIBQuery
    Database = Dados.Database
    Transaction = Dados.Transaction
    SQL.Strings = (
      
        'select B.CodBanco, B.nome as NomeBanco, B.fantasia, CI.Nome as N' +
        'omeCidade '
      'from Bancos B '
      'inner join Cidades CI on B.CodCidade = CI.CodCidade')
    Left = 112
    Top = 112
    object QryBuscaBancoCODBANCO: TIntegerField
      FieldName = 'CODBANCO'
      Origin = 'BANCOS.CODBANCO'
      Required = True
    end
    object QryBuscaBancoNOMEBANCO: TIBStringField
      FieldName = 'NOMEBANCO'
      Origin = 'BANCOS.NOME'
      Size = 75
    end
    object QryBuscaBancoFANTASIA: TIBStringField
      FieldName = 'FANTASIA'
      Origin = 'BANCOS.FANTASIA'
      Size = 75
    end
    object QryBuscaBancoNOMECIDADE: TIBStringField
      FieldName = 'NOMECIDADE'
      Origin = 'CIDADES.NOME'
      Size = 100
    end
