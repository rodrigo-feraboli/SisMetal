object FRelCidades: TFRelCidades
  Left = 213
  Top = 124
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Emiss'#227'o de Relat'#243'rios de Cidades'
  ClientHeight = 107
  ClientWidth = 334
  Color = clBtnFace
  ...
  object QryCidades: TIBQuery
    ...
    SQL.Strings = (
      'select C.Codcidade, C.Nome as NomeCidade, C.Cep, '
      'E.Nome as NomeEstado from'
      'Cidades C'
      'inner join estados E on E.codestado = C.codestado')
    Left = 296
    Top = 16
    object QryCidadesCODCIDADE: TIntegerField
      FieldName = 'CODCIDADE'
      Origin = 'CIDADES.CODCIDADE'
      Required = True
    end
    object QryCidadesNOMECIDADE: TIBStringField
      FieldName = 'NOMECIDADE'
      Origin = 'CIDADES.NOME'
      Size = 100
    end
    object QryCidadesCEP: TIBStringField
      FieldName = 'CEP'
      Origin = 'CIDADES.CEP'
      EditMask = '99.999-999;0;_'
      Size = 8
    end
    object QryCidadesNOMEESTADO: TIBStringField
