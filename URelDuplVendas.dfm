object FRelDuplVendas: TFRelDuplVendas
  Left = 80
  Top = 158
  ...
  object QryGenerica: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select CD.nome, CRP.vctoparc, CRP.pgtoparc, CRP.vlrparc, CRP.vlr' +
        'pago, CRP.Situacao  from creceberparcs CRP'
    ...
    object QryGenericaVCTOPARC: TDateField
      FieldName = 'VCTOPARC'
      Origin = '"CRECEBERPARCS"."VCTOPARC"'
    end
    object QryGenericaPGTOPARC: TDateField
      FieldName = 'PGTOPARC'
      Origin = '"CRECEBERPARCS"."PGTOPARC"'
    end
    object QryGenericaVLRPARC: TIBBCDField
      FieldName = 'VLRPARC'
      Origin = '"CRECEBERPARCS"."VLRPARC"'
      Precision = 18
      Size = 2
    end
    object QryGenericaVLRPAGO: TIBBCDField
      FieldName = 'VLRPAGO'
      Origin = '"CRECEBERPARCS"."VLRPAGO"'
      Precision = 18
      Size = 2
    end
    object QryGenericaSITUACAO: TIBStringField
      FieldName = 'SITUACAO'
