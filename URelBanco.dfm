object FRelBanco: TFRelBanco
  Left = 205
  Top = 147
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Emiss'#227'o de Relat'#243'rios de Bancos'
  ClientHeight = 106
  ClientWidth = 335
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object QRGroup1: TQRGroup
      ...
      Size.Values = (
        47.625
        1899.70833333333)
      Expression = 'QryClientes.NOMECITY'
      Master = QuickRep1
  ...
  object QryBanco: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select B.codbanco, B.nome, B.endereco, B.fone, B.datacadastro, c' +
        'i.nome as NomeCity from Bancos B'
      'inner join cidades ci on ci.codcidade = b.codcidade')
    Left = 304
    Top = 16
    object QryBancoCODBANCO: TIntegerField
      FieldName = 'CODBANCO'
    ...
    object QryBancoENDERECO: TIBStringField
      FieldName = 'ENDERECO'
      Origin = '"BANCOS"."ENDERECO"'
      Size = 100
    end
    object QryBancoFONE: TIBStringField
      FieldName = 'FONE'
      Origin = '"BANCOS"."FONE"'
      Size = 15
    end
    object QryBancoDATACADASTRO: TDateField
      FieldName = 'DATACADASTRO'
      Origin = '"BANCOS"."DATACADASTRO"'
    end
    object QryBancoNOMECITY: TIBStringField
      FieldName = 'NOMECITY'
      Origin = 'CIDADES.NOME'
      Size = 100
    end
